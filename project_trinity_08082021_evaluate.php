	...
	<nav class="navbar navbar-default crmnav">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="project_trinity_08082021.php">Home</a></li>
				...
				<li class="dropdown active" id="evaluate">
			...
			<h4 class="header">Project Kartos Campaign Evaluate</h4>
			<h4 align="right" class="logout"><a href="../../logout.php"> <?php echo $_COOKIE['derbyusername']; ?> <span class="glyphicon glyphicon-hand-right"></span></a></h4>
		</div>
	</nav>
	<div id="mainbody">
			...
			<form class="form-inline" action="" method="POST">
				<div class="form-group">
					<div class="input-group">
						<input type="text" class="form-control" id="number" name="sl" placeholder="Serial Number">
					</div>
				</div>
		...
		<div class="container">
			<form action="project_trinity_08082021_evlupdate.php" method="post">
				<div class="form-group col-md-3">
					<label for="">MSISDN</label>
					<input type="text" class="form-control" id="msisdn" placeholder="" name="msisdn" readonly value="<?php echo $rowupdata['ConsumerNumber']; ?>">
				</div>
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control" id="nameverified" name="nameverified">
						<option value="<?php echo $rowupdata['NameVerified']; ?>"><?php echo $rowupdata['NameVerified']; ?></option>
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control" id="ageverified" name="ageverified">
						<option value="<?php echo $rowupdata['AgeVerified']; ?>"><?php echo $rowupdata['AgeVerified']; ?></option>
						<option value="">Select</option>
						<option value="Yes">Yes</option>
						<option value="No">No</option>
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control" id="brcontact" name="cbr">
						<option value="<?php echo $rowupdata['ConductedbyBR']; ?>"><?php echo $rowupdata['ConductedbyBR']; ?></option>
						<option value="">Select</option>
						<option value="Yes">Yes</option>
						<option value="No">No</option>
					</select>
				...
				<div class="form-group col-md-4">
					...
					<select class="form-control" id="full_flavoured_somke" name="full_flavoured_somke">
						<option value="<?php echo $rowupdata['full_flavoured_somke']; ?>"><?php echo $rowupdata['full_flavoured_somke']; ?></option>
						<option value="Yes">Yes</option>
						<option value="No">No</option>
					</select>
				</div>
				...
				<div class="form-group col-md-5">
					...
					<select class="form-control" id="blueberry_and_lemon_flavour" name="blueberry_and_lemon_flavour">
						<option value="<?php echo $rowupdata['blueberry_and_lemon_flavour']; ?>"><?php echo $rowupdata['blueberry_and_lemon_flavour']; ?></option>
						<option value="Yes">Yes</option>
						<option value="No">No</option>
					</select>
				</div>
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control" id="current_primary_brand" name="current_primary_brand">
						<option value="<?php echo $rowupdata['current_primary_brand']; ?>"><?php echo $rowupdata['current_primary_brand']; ?></option>
				...
				<div class="form-group col-md-5" id="current_primary_brand_other_div" style="display: none;">
					...
					<input type="text" name="current_primary_brand_other" id="current_primary_brand_other" class="form-control" placeholder="" value="<?php echo $rowupdata['current_primary_brand_other']; ?>">
				</div>
				<div class="form-group col-md-3">
					<label for="">Consumer Secondary Brand</label>
					<select class="form-control" id="current_secon_brand" name="current_secon_brand">
						<option value="<?php echo $rowupdata['current_secon_brand']; ?>"><?php echo $rowupdata['current_secon_brand']; ?></option>
						<option value="B & H">B & H</option>
						<option value="Capstan">Capstan</option>
						<option value="Derby">Derby</option>
						<option value="Derby Style">Derby Style</option>
				...
				<div class="form-group col-md-5" id="current_secon_brand_other_div" style="display: none;">
					<label for="">Other Brand</label>
					<input type="text" name="current_secon_brand_other" id="current_secon_brand_other" class="form-control" value="<?php echo $rowupdata['current_secon_brand_other']; ?>">
				</div>

				<div class="form-group col-md-3">
					<label for="">Profession</label>
					<input type="text" name="profession" id="profession" class="form-control" value="<?php echo $rowupdata['profession']; ?>">
				</div>

				<div class="form-group col-md-3">
					<label for="">Job_Business_Study</label>
					<input type="text" name="job_business_study" id="job_business_study" class="form-control" value="<?php echo $rowupdata['job_business_study']; ?>">
				</div>
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control" id="express_thanks" name="express_thanks">
						<option value="<?php echo $rowupdata['express_thanks']; ?>"><?php echo $rowupdata['express_thanks']; ?></option>
						<option value="Yes">Yes</option>
						<option value="No">No</option>
					</select>
				</div>
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control" id="callstatus" required name="callstatus">
						<option value="<?php echo $rowupdata['Callstatus']; ?>"><?php echo $rowupdata['Callstatus']; ?></option>
				...
				<div class="form-group col-md-3">
					...
					<select class="form-control" id="callremarks" required name="callremarks">
						<option value="<?php echo $rowupdata['Callremarks']; ?>"><?php echo $rowupdata['Callremarks']; ?></option>
					</select>
				</div>
