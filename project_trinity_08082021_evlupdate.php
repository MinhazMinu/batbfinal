...
$statusquery = mysql_query("SELECT firstStatus,SecondStatus,ThirdStatus FROM project_trinity_08082021  WHERE sl='$code'");
$rowupdata = mysql_fetch_array($statusquery);
$fstatus = $rowupdata['firstStatus'];
$sstatus = $rowupdata['SecondStatus'];
$tstatus = $rowupdata['ThirdStatus'];

if (empty($sstatus) and empty($tstatus)) {
	$updatedb = mysql_query("UPDATE project_trinity_08082021  SET firstStatus='$callstatus', firstRemarks='$callremarks', NameVerified='$nameverified', AgeVerified='$ageverified',ConductedbyBR='$cbr',full_flavoured_somke='$full_flavoured_somke',blueberry_and_lemon_flavour='$blueberry_and_lemon_flavour',current_primary_brand='$current_primary_brand',current_primary_brand_other='$current_primary_brand_other',current_secon_brand='$current_secon_brand',current_secon_brand_other='$current_secon_brand_other',profession='$profession',job_business_study='$job_business_study',express_thanks='$express_thanks',SubmitDate='$Stime',Callstatus='$callstatus',Callremarks='$callremarks',UseriD='$userid' WHERE sl='$code'");
} elseif (empty($tstatus)) {
	$updatedb = mysql_query("UPDATE project_trinity_08082021  SET SecondStatus='$callstatus', SecondRemarks='$callremarks', NameVerified='$nameverified', AgeVerified='$ageverified',ConductedbyBR='$cbr',full_flavoured_somke='$full_flavoured_somke',blueberry_and_lemon_flavour='$blueberry_and_lemon_flavour',current_primary_brand='$current_primary_brand',current_primary_brand_other='$current_primary_brand_other',current_secon_brand='$current_secon_brand',current_secon_brand_other='$current_secon_brand_other',profession='$profession',job_business_study='$job_business_study',express_thanks='$express_thanks',SubmitDate='$Stime',Callstatus='$callstatus',Callremarks='$callremarks',UseriD='$userid' WHERE sl='$code'");
} else {
	$updatedb = mysql_query("UPDATE project_trinity_08082021  SET ThirdStatus='$callstatus', ThirdRemarks='$callremarks', NameVerified='$nameverified', AgeVerified='$ageverified',ConductedbyBR='$cbr',full_flavoured_somke='$full_flavoured_somke',blueberry_and_lemon_flavour='$blueberry_and_lemon_flavour',current_primary_brand='$current_primary_brand',current_primary_brand_other='$current_primary_brand_other',current_secon_brand='$current_secon_brand',current_secon_brand_other='$current_secon_brand_other',profession='$profession',job_business_study='$job_business_study',express_thanks='$express_thanks',SubmitDate='$Stime',Callstatus='$callstatus',Callremarks='$callremarks',UseriD='$userid' WHERE sl='$code'");
}
...
if ($updatedb) {
	...
	mysql_close();
	echo "<script>setTimeout(\"location.href = 'project_trinity_08082021_evaluate.php';\",100);</script>";
} else {
