...
<body>
  <nav class="navbar navbar-default crmnav">
    <div class="container-fluid">
      ...
      <h4 class="header">Project Kartos Campaign Report</h4>
  ...
  <div class="container">
    <form role="form" action="project_trinity_08082021_batcdr_export.php" method="post">

      <div class="form-group col-md-2">
        <input class="form-control" placeholder="Start Date" type="text" id='datetimepicker1' name="datetimepicker1" required>
      </div>
      <div class="form-group col-md-2">
        <input class="form-control" placeholder="End Date" type="text" id='datetimepicker2' name="datetimepicker2" required>
      </div>
      <div class="form-group col-md-2">
        <select class="form-control" id="treport" required name="treport">
          ...
          <option value="unique">Unique Raw</option>
          <option value="br_authentication">BR Authentication Report</option>
        </select>
      </div>
